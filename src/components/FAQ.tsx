...
export function FAQ() {
  return (
    <>
      <div className='absolute right-30 z-10 mt-4'>
        <Image
          src='/tanda-tanya.svg'
      ...
      <div className='my-64 h-150 bg-radial from-[#198AE5] from-9% to-[#4971A9] rounded-[50px]'>
        <div className='flex flex-col gap-8 px-32 py-16 z-20 w-full h-full'>
          <p className='text-5xl font-semibold text-white text-shadow-lg'>
            Everything You Need to <span className='tertiary-color'>Know.</span>
          </p>
          <CardFAQ
