        ...
        <div className='absolute bg-white w-full 4xs:h-70 2xs:h-40 md:h-50 lg:h-60 xl:h-70 z-10 rounded-bl-[100px]'>
          <div className='flex gap-2 4xs:flex-col 4xs:mt-20 2xs:flex-row 2xs:mt-10 md:mt-16 lg:mt-20 xl:mt-28 4xs:ml-6 2xs:ml-10 md:ml-20'>
            <Image
              ...
              width={152}
              height={152}
              className='4xs:w-[60px] 2xs:w-[60px] md:w-[80px] lg:w-[110px] xl:w-[152px]'
            />
            <div className='flex flex-col gap-2 4xs:w-40 2xs:w-22 md:w-50 lg:w-70 xl:w-90 justify-center'>
              <p className='4xs:text-[10px] 2xs:text-[8px] md:text-[10px] lg:text-[12px] xl:text-[15px] primary-color'>
                Clypsera provides accurate and organized data on cleft lip cases
                to support better healthcare and research.
              </p>
              <Link
                href='/about'
                className='4xs:text-[10px] 2xs:text-[8px] md:text-[10px] lg:text-[12px] xl:text-[18px] font-bold primary-color'
              >
                Learn More
              </Link>
            </div>
